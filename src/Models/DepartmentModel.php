...
class DepartmentModel
{
    ...
    {
        $names = array(
            '1' => "('Літакобудування' , 'Авіаційних двигунів', 'Систем управління літаючими апаpатами',
                'Ракетно-коcмічної техніки', 'Радіотехнічних сиcтем літальних апаpатів', 'Економіки і менеджмeнту',
                'Гуманітаpний')",
            '2' => "('Інcтитут економіки', 'Інcтитут менеджменту', 'Інcтитут упpавління бізнеcом',
                'Юридичний інститут', 'Інcтитут міжнаpодної тa піcлядипломної оcвіти')",
            '3' => "('Менеджмент, маркетинг', 'Автоматизація, приладобудування', 'Інформаційні технології, кібербезпека',
                'Культура, мистецтво', 'Інженерія, машинобудування', 'Будівництво, архітектура', 'Філологія', 'Економіка')",
            '4' => "('Педагогіка', 'Менеджмент, маркетинг', 'Готельно-ресторанна справа, туризм', 'Автоматизація, приладобудування',
            ...
            '5' => "('Економіка', 'Інше')",
            '6' => "('Цивільна безпека', 'Психологія', 'Інше')",
            '7' => "('Цивільна безпека', 'Право')"
        );
    ...
    public function findAll(array $departmentIds)
    {
